...
namespace osu.Game.Screens.Menu
{
    public partial class ButtonSystem : Container, IStateful<ButtonSystemState>, IKeyBindingHandler<GlobalAction>
    {
        ...
        private void load(AudioManager audio, IdleTracker? idleTracker, GameHost host)
        {
            ...
            buttonsTopLevel.Add(new MainMenuButton(ButtonSystemStrings.Tutorial, @"button-play-select", FontAwesome.Solid.QuestionCircle, new Color4(106, 70, 225, 255), onTutorial, Key.T)
            {
                Padding = new MarginPadding { Left = WEDGE_WIDTH }
            });
            buttonsTopLevel.Add(new MainMenuButton(ButtonSystemStrings.Solo, @"button-play-select", FontAwesome.Solid.User, new Color4(102, 68, 204, 255), (_, _) => OnSolo?.Invoke(), Key.P)
            );
            buttonsTopLevel.Add(new MainMenuButton(ButtonSystemStrings.Multi, @"button-play-select", FontAwesome.Solid.UserFriends, new Color4(94, 63, 186, 255), onMultiplayer, Key.M));
        ...
        private void onTutorial(MainMenuButton mainMenuButton, UIEvent uIEvent)
        {
            // TTKTODO: quick open tutorial
            return;
        ...
        private bool onOsuLogo()
        {
            switch (state)
            {
                ...
                case ButtonSystemState.TopLevel:
                    buttonsTopLevel[1].TriggerClick();
                    return false;
